...
把这个 prompt 贴给 Claude，配合你的项目源码即可生成 5 张架构图。

---

## Prompt

请为我的项目生成 5 张 Mermaid 架构图，输出为一个自包含的 HTML 文件。
...
| 4 | 数据模型 ER 图 | `erDiagram` | 核心实体及其字段、关系 |
| 5 | 请求时序图 | `sequenceDiagram` | 一次完整调用链，≤6 参与方，用 par 和 alt |
